...
bool UnorderedArrayList::contains(int data) {
    // Put in the logic to check if the array contains the specified data
    // Return true if found, false otherwise
}

int UnorderedArrayList::get(int index) {
    // Put in the logic to get the data at the specified index
    // Return the data if index is correct, otherwise
}

int UnorderedArrayList::indexOf(int data) {
    // Put in the logic to find the index of the specified data
    // Return the index if found, -1 otherwise
}

bool UnorderedArrayList::isEmpty() {
    // Put in the logic to check if the array is empty
    // Return true if empty, false otherwise
}

int UnorderedArrayList::remove(int index) {
    // Put in the logic to remove the data at the specified index
    // Return the removed data if index is correct, otherwise
}

bool UnorderedArrayList::removeAll(int data) {
    // Put in the logic to remove all the times of the specified data
    // Return true if at least one time is removed, false otherwise
}

int UnorderedArrayList::size() {
    // Put in the logic to get the size of the array
    // Return the size
}

void UnorderedArrayList::trimToSize() {
    // Put in the logic to trim the capacity to the current size
}
